...
public class Logger {
    ...
    // Create dummy logger by setting up a dummy flag which can be also used in case of loggerException
    // (wrong turn or something like that - errors included can be made to include more stuff later)
